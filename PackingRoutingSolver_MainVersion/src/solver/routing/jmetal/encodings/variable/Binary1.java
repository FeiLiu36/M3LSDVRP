 ...
 * or real variables).
 */ 
public class Binary1 extends Variable {
   ...
   */
  public Binary1(int numberOfBits){   
   ...
   */
  public Binary1(Binary1 variable){
  ...
  */
  public int hammingDistance(Binary1 other) {
    int distance = 0;
    int i = 0;
    while (i < bits_.size()) {
