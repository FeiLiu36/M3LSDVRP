...
public class MutationFactory {
  ...
  public static Mutation getMutationOperator(String name, HashMap parameters) throws JMException{
    ...
    else if (name.equalsIgnoreCase("SwapBitFlipMutation"))
        return new SwapBitFlipMutation(parameters);
    else if (name.equalsIgnoreCase("SwapMutation_mod"))
        return new SwapMutation_mod(parameters);
