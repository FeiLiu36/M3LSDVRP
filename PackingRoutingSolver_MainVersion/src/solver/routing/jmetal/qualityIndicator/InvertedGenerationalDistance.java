 ...
 * "java solver.routing.jmetal.qualityIndicator.InvertedGenerationalDistance <solutionFrontFile> <trueFrontFile> 
...
public class InvertedGenerationalDistance {
  public solver.routing.jmetal.qualityIndicator.util.MetricsUtil utils_;  //utils_ is used to access to the
