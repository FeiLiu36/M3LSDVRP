...
package solver.routing.jmetal.qualityIndicator;
 ...
 * $ java solver.routing.jmetal.qualityIndicator.GeneralizedSpread <solutionFrontFile> <trueFrontFile> <getNumberOfObjectives>
...
public class GeneralizedSpread {
  ...
  public static solver.routing.jmetal.qualityIndicator.util.MetricsUtil utils_;  // MetricsUtil provides some 
  ...
  public GeneralizedSpread() {
    utils_ = new solver.routing.jmetal.qualityIndicator.util.MetricsUtil();
  } // GeneralizedSpread
  ...
  public double generalizedSpread(double [][] paretoFront,
    ...
    for (int i = 0; i < numberOfObjectives; i++) {
      Arrays.sort(normalizedParetoFront,new solver.routing.jmetal.qualityIndicator.util.ValueComparator(i));
    ...
    Arrays.sort(normalizedFront,new solver.routing.jmetal.qualityIndicator.util.LexicoGraphicalComparator());
