 ...
 *  "java solver.routing.jmetal.qualityIndicator.Spread <solutionFrontFile> <trueFrontFile>". 
...
public class Spread {
  ...
  public static solver.routing.jmetal.qualityIndicator.util.MetricsUtil utils_;//utils_ is used to access to 
  ...
  public double spread(double [][] front, 
    ...
    Arrays.sort(normalizedFront,
    		    new solver.routing.jmetal.qualityIndicator.util.LexicoGraphicalComparator());
