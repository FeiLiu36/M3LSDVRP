...
package solver.routing.jmetal.core;
...
public class Solution implements Serializable {  
   ...
   */
  public final double [] objective_ ;
   ...
   */
  public double  overallConstraintViolation_ ;
  ...
  public int getNumberOfBits() {
    ...
    for (int i = 0;  i < variable_.length  ; i++)
      if ((variable_[i].getVariableType() == solver.routing.jmetal.encodings.variable.Binary.class) ||
          (variable_[i].getVariableType() == solver.routing.jmetal.encodings.variable.BinaryReal.class))
