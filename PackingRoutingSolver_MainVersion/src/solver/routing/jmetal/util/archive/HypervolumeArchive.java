...
package solver.routing.jmetal.util.archive;

import solver.routing.jmetal.core.Solution;
import solver.routing.jmetal.qualityIndicator.util.MetricsUtil;
import solver.routing.jmetal.util.Distance;
import solver.routing.jmetal.util.comparators.CrowdingDistanceComparator;
import solver.routing.jmetal.util.comparators.DominanceComparator;
import solver.routing.jmetal.util.comparators.EqualSolutions;
...
public class HypervolumeArchive extends Archive {
	...
	/**
	 * Adds a <code>Solution</code> to the archive. If the <code>Solution</code> is
	 * dominated by any member of the archive, then it is discarded. If the
	...
	/**
	 * This method forces to compute the contribution of each solution (required for
	 * PAEShv)
	 */
	...
	/**
	 * This method returns the location (integer position) of a solution in the
	 * archive. For that, the equals_ comparator is used
	 * 
	 */
