...
package solver.routing.jmetal.util.wrapper;

import solver.routing.jmetal.core.Solution;
import solver.routing.jmetal.core.SolutionType;
import solver.routing.jmetal.encodings.solutionType.ArrayRealAndBinarySolutionType;
import solver.routing.jmetal.encodings.solutionType.ArrayRealSolutionType;
import solver.routing.jmetal.encodings.solutionType.BinaryRealSolutionType;
import solver.routing.jmetal.encodings.solutionType.RealSolutionType;
import solver.routing.jmetal.encodings.variable.ArrayReal;
...
public class XReal {
	...
	public double getValue(int index) throws JMException {
		if ((type_.getClass() == RealSolutionType.class) ||
			...
			Configuration.logger_.severe("solver.routing.jmetal.util.wrapper.XReal.getValue, solution type " +
					type_ + "+ invalid") ;		
		}
		return 0.0 ;
	}
	...
	public void setValue(int index, double value) throws JMException {
		if (type_.getClass() == RealSolutionType.class)
			...
			Configuration.logger_.severe("solver.routing.jmetal.util.wrapper.XReal.setValue, solution type " +
					type_ + "+ invalid") ;		
	} // setValue	
	...
	public double getLowerBound(int index) throws JMException {
		if ((type_.getClass() == RealSolutionType.class) ||
			...
			Configuration.logger_.severe("solver.routing.jmetal.util.wrapper.XReal.getLowerBound, solution type " +
					type_ + "+ invalid") ;		
	...
	public double getUpperBound(int index) throws JMException {
		if ((type_.getClass() == RealSolutionType.class) ||
			...
			Configuration.logger_.severe("solver.routing.jmetal.util.wrapper.XReal.getUpperBound, solution type " +
					type_ + "+ invalid") ;		
	...
	public int getNumberOfDecisionVariables() {
		if ((type_.getClass() == RealSolutionType.class) ||
			...
			Configuration.logger_.severe("solver.routing.jmetal.util.wrapper.XReal.size, solution type " +
					type_ + "+ invalid") ;		
		return 0 ;
