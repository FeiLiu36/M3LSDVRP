...
public class Box implements Comparable ,Cloneable{
	...
	private double fragile = 1.0; // fragile ratio, load bearing strength, 
	//maximum weight per unit area that a box can uphold depending on its type and its vertical orientation
